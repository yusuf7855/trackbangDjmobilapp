  ...
  String _buildImageUrl(String imageUrl) {
    ...
    if (imageUrl.startsWith('http://') || imageUrl.startsWith('https://')) {
      ...
      if (finalUrl.contains('localhost') || finalUrl.contains('127.0.0.1')) {
        finalUrl = finalUrl.replaceAll('localhost', 'https://trackbangserver.com');
        finalUrl = finalUrl.replaceAll('127.0.0.1', 'https://trackbangserver.com');
      }
      if (finalUrl.contains('10.0.2.2')) {
        finalUrl = finalUrl.replaceAll('10.0.2.2', 'https://trackbangserver.com');
      }
